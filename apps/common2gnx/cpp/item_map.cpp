...
//	declare syntactic properties.
	...
	add( "do", 			tokty_do, 			Clo, 		0			);
	add( "else", 		tokty_else, 		Clo, 		0			);
	add( "elseif", 		tokty_elseif, 		Clo, 		0			);
	add( "elseunless", 	tokty_elseunless, 	Clo, 		0			);
	add( "enddefine", 	tokty_enddefine, 	Clo, 		0			);
	add( "endfn", 		tokty_endfn, 		Clo, 		0			);
	add( "endfor", 		tokty_endfor, 		Clo, 		0			);
	add( "endif", 		tokty_endif, 		Clo, 		0			);
	add( "endpackage", 	tokty_endpackage, 	Clo, 		0			);
	add( "endunless", 	tokty_endunless, 	Clo, 		0			);
