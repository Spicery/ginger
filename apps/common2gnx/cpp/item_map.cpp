...
ItemMap::ItemMap( const bool cstyle_mode ) {
//	declare syntactic properties.
	...
	add( !cstyle_mode,	 "define", 		tokty_define, 		PrF, 		0			);
	add( !cstyle_mode,	 "do", 			tokty_do, 			Clo, 		0			);
	add( true,	 "else", 		tokty_else, 		Clo, 		0			);
	add( !cstyle_mode,	 "elseif", 		tokty_elseif, 		Clo, 		0			);
	add( !cstyle_mode,	 "elseunless", 	tokty_elseunless, 	Clo, 		0			);
	add( !cstyle_mode,	 "enddefine", 	tokty_enddefine, 	Clo, 		0			);
	add( !cstyle_mode,	 "endfn", 		tokty_endfn, 		Clo, 		0			);
	add( !cstyle_mode,	 "endfor", 		tokty_endfor, 		Clo, 		0			);
	add( !cstyle_mode,	 "endif", 		tokty_endif, 		Clo, 		0			);
	add( !cstyle_mode,	 "endpackage", 	tokty_endpackage, 	Clo, 		0			);
	add( !cstyle_mode,	 "endunless", 	tokty_endunless, 	Clo, 		0			);
	add( !cstyle_mode,	 "fn", 			tokty_fn, 			PrF, 		0			);
	add( true,	 "for", 		tokty_for, 			PrF, 		0			);
	add( true,	 "from",		tokty_from, 		Pat,		2000		);
	add( cstyle_mode,	 "function", 	tokty_function, 	PrF, 		0			);
	...
	add( !cstyle_mode,	 "then", 		tokty_then, 		Clo, 		0			);
