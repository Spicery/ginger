...
instructionSet = [
	...
	Instruction( "check_mark_gte", "irr" ),
	Instruction( "dup", "i" ),
	...
	Instruction( "lt_si", "ircr" ),
	Instruction( "lt_ss", "irrr" ),
	Instruction( "lte_si", "ircr" ),
	Instruction( "lte_ss", "irrr" ),
	Instruction( "mod", "i" ),
	Instruction( "neq_si", "ircr" ),
	...
	Instruction( "pushq_pop_local", "icr" ),
	Instruction( "pushq_ret", "ic" ),
	Instruction( "quo", "i" ),
	#Instruction( "rem", "i" ),		# Disabling remainder, in favour of mod (floored remainder).
	Instruction( "reset", "i" ),
	...
	Instruction( "set_count_syscall", "irr" ),
